...
<script>
	$(document).ready(function() {
		...
		//用户观看了40分钟时，弹出星级评论框
		$("#star").fadeIn(15);//星星评分显示
		$("#star").fadeOut(10000);//星星评分隐藏
	});
				...
				<c:when test="${username!=null&&username=='admin'}">
					<div id="user_operater">
						...
						<div class="register" onclick="logout()">
							<a href="user_logout" target="_self" onclick="logout()">注销</a>
						</div> 
					</div>
				</c:when>
				<c:otherwise>
				...
				<div id="lists">
					<ol id="hotList">
						<li class="item item_last">
							<div class="user_icon">
								<a href="#" class="atUser"
									data-oid="32388104" data-ucode="7zVWuBpet7g"><img src="img/M-07.png"></a>
							</div>
							<p class="hd fix">
